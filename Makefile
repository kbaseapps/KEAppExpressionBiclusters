SERVICE = keappexpressionbiclusters
SERVICE_CAPS = KEAppExpressionBiclusters
SPEC_FILE = KEAppExpressionBiclusters.spec
URL = https://kbase.us/services/keappexpressionbiclusters
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
