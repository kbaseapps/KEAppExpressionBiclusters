 ...
 * </pre>
 */
public class KEAppExpressionBiclustersClient {
     ...
     */
    public KEAppExpressionBiclustersClient(URL url) {
     ...
     * validity.
     */
    public KEAppExpressionBiclustersClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public KEAppExpressionBiclustersClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public KEAppExpressionBiclustersClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("KEAppExpressionBiclusters.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
